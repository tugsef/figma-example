...
export const ContactForm = () => {
  return (
    <div className="lg:flex lg:w-full  md:gap-10  lg:bg-gray lg:rounded-[45px] lg:p-16 lg:gap-20 xl:gap-52">
      <div className="space-y-8 flex-1">
        <div className="bg-gray py-10 px-8 rounded-[45px] space-y-9 lg:px-0">
